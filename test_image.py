...
path = '/Users/shreesh/Downloads/SRGAN-tensorflow-master/data/'
im_gt = data_transforms(imread(path+'test_HR/img_001.png')).numpy()
im_b  = data_transforms(imread(path+'test_LR/img_001.png')).numpy()
im_input = im_b
